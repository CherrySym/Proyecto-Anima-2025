...
const CVyCarta = () => {
  ...
  return (
    <div className="cvycarta-page">
      <SimpleNavbar title="Job Path" />

      <main className="cvycarta-content">
        {/* Header */}
        ...
        <div className="main-grid">
          {/* CV Section */}
          <div className="document-section cv-section">
            <h2 className="section-title">{t.cv.title}</h2>
            <p className="section-intro">{t.cv.intro}</p>
            ...
            <div className="example-image">
              ...
              <p className="image-caption">{t.cv.example}</p>
            </div>
          </div>

          {/* Carta Section */}
          <div className="document-section carta-section">
            <h2 className="section-title">{t.carta.title}</h2>
            <p className="section-intro">{t.carta.intro}</p>
            ...
            <div className="example-image">
              ...
              <p className="image-caption">{t.carta.example}</p>
            </div>
          </div>
        </div>
        ...
        <div className="resources-section">
          ...
          <div className="resources-buttons">
            <button onClick={() => alert('Plantilla CV descargada')} className="resource-btn primary">
              📄 {t.resources.button1}
            </button>
            <button onClick={() => alert('Plantilla Carta descargada')} className="resource-btn primary">
              📝 {t.resources.button2}
            </button>
            <button onClick={() => navigate('/consejos')} className="resource-btn secondary">
              📚 {t.resources.button3}
            </button>
            <button onClick={() => navigate('/contacto')} className="resource-btn tertiary">
              💬 {t.resources.button4}
            </button>
          </div>
        </div>
