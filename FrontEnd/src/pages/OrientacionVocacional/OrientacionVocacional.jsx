...
const OrientacionVocacional = () => {
  ...
  return (
    <div className="orientacion-page">
        ...
        <div className="main-layout">
          ...
          <div className="center-column">
            ...
            <div className="button-list">
              ...
              <a href="#" onClick={(e) => { e.preventDefault(); navigate('/cv-y-carta'); }} className="action-button">
                {t.cvBtn}
              </a>
              <a href="#" onClick={(e) => { e.preventDefault(); navigate('/entrevistas'); }} className="action-button">
                {t.interviewBtn}
              </a>
              <a href="#" onClick={(e) => { e.preventDefault(); navigate('/orientacion-personalizada'); }} className="action-button">
                {t.supportBtn}
              </a>
            </div>
          </div>
