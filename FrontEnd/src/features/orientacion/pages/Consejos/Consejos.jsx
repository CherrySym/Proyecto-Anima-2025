...
// import './Consejos.css'; // backup of original global stylesheet
...
const Consejos = () => {
  ...
  return (
    <div className={styles['consejos-page']}>
      <SimpleNavbar title="Job Path" />

      <main className={styles['consejos-content']}>
        {/* Header */}
        ...
        <div className={styles['cta-section']}>
          ...
          <div className={styles['cta-buttons']}>
            <button onClick={() => navigate('/cursos')} className={`${styles['cta-button']} ${styles['primary']}`}>
              {t.cta.button1}
            </button>
            <button onClick={() => navigate('/orientacion-vocacional')} className={`${styles['cta-button']} ${styles['secondary']}`}>
              {t.cta.button2}
            </button>
            <button onClick={() => navigate('/contacto')} className={`${styles['cta-button']} ${styles['tertiary']}`}>
              {t.cta.button3}
            </button>
          </div>
        </div>
