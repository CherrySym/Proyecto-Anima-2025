...
import styles from './OrientacionPersonalizada.module.css';
// import './OrientacionPersonalizada.css'; // backup of original stylesheet
...
const OrientacionPersonalizada = () => {
  ...
  return (
    <div className={styles['orientacion-personalizada-page']}>
      <SimpleNavbar title="Job Path" />

      <main className={styles['main-container-op']}>
        <div className={styles['top-bar-op']}>
          <button onClick={() => navigate('/orientacion-vocacional')} className={styles['btn-volver-atras']}>
            {t.backBtn}
          </button>
          <h2 className={styles['vocational-orientation-op']}>{t.vocationalOrientation}</h2>
        </div>

        <section className={styles['title-section-op']}>
          <h1 className={styles['main-title-op']}>{t.mainTitle}</h1>
        </section>

        <section className={styles['advice-pair-op']}>
          <div className={`${styles['left-section-op']} ${styles['full-width-op']}`}>
            <article className={styles['advice-box-op']}>
          ...
          <div className={`${styles['right-section-op']} ${styles['full-width-op']}`}>
            <aside className={styles['tips-section-op']}>
              <h3 className={styles['tips-title-op']}>{t.contactTitle}</h3>
              <ul>
                <li>
        ...
        <section className={styles['advice-pair-op']}>
          ...
          <div className={`${styles['right-section-op']} ${styles['full-width-op']}`}>
            <aside className={styles['tips-section-op']}>
              <h3 className={styles['tips-title-op']}>{t.adviceTypesTitle}</h3>
              <ul>
                <li>
